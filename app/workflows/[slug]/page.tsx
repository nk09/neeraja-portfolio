    ...
    <main className="mx-auto max-w-3xl px-6 py-12">
      <div className="glass rounded-3xl p-8 sm:p-10">
        ...
        <p className="mt-4 text-slate-300">
          Deep-dive page for this workflow. If you landed here from a post, this URL is stable and
        ...
        <div className="mt-8 space-y-3 rounded-2xl border border-white/10 bg-white/5 p-5">
          ...
          <ul className="list-disc pl-5 text-slate-300 space-y-1">
            ...
            <li>Pipeline stages, SLIs/SLOs, and alerting strategy</li>
            <li>Hard-won lessons (what broke in prod and how it was fixed)</li>
          </ul>
        </div>
